...
class LogMgr():
    def __init__(self,name):
        ...
        #创建一个日志文件，写到日志文件
        #self.fh=logging.FileHandler(r'yunbao.log',encoding='utf-8')
